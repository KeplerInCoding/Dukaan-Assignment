...
const Header = () => {
  return (
    <div className='flex place-content-between p-2 items-center bg-white shadow-sm shadow-gray-300 sha'>
        <div className='flex'>
        ...
        <div className=' text-gray-500 rounded-md text-xs bg-gray-100 p-2 w-80 flex items-center gap-x-2'>
            <i class="fas fa-search"></i>
            <input className='bg-gray-100' type="text" placeholder="Search features, tutorials." />
        </div>
